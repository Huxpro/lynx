...
static constexpr int64_t kFifteenMinutesInSeconds = 900;
static constexpr int64_t kThirtyMinutesInSeconds = 1800;
static constexpr int64_t kOneHourInSeconds = 3600;
